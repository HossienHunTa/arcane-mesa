<template>
    ...
    <div class="boxuser">
      <router-link to="/user"><b-button id="btn" class="btn" variant="primary">کاربر</b-button></router-link>
      <router-link v-if="show" to="/users"><b-button id="btn" class="btn" variant="info">کاربران</b-button></router-link>
    </div>
    ...
    <b-form-group class="col-sm-4 mr-3" id="gp_id" label="ایدی کاربر" label-for="id">
      ...
      <b-form-group class="col-sm-3 mr43" id="gp_phoneNumber" label="شماره همراه" label-for="phoneNumber">
        <b-form-input id="phoneNumber" v-model="form.phoneNumber" type="tel" placeholder="09151234567"> 	</b-form-input>
      </b-form-group>
